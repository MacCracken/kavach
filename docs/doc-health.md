...
| `004-deferred-features.md` | 📦 Frozen — accepted, status-updated | The deliberate-deferral list. v3.12.9 appended a status table checked against the source: seven of nine items shipped (async exec and full regex remain). v3.13.0 re-dated it: §2's SGX / TDX quote verification shipped; quote fetch and SEV-SNP remain, with what the launchers lack. |
